...
import 'package:expenses_wise/widgets/chart/chart_bar.dart';
...
class Chart extends StatelessWidget {
  ...
  List<ExpenseBucket> get buckets {
    return [
      ...
      ExpenseBucket.forCategory(expenses, Category.credit),
      ExpenseBucket.forCategory(expenses, Category.debit),
      ExpenseBucket.forCategory(expenses, Category.installments),
